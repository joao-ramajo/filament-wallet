...
<head>
    ...
    <meta name="description" content="Filament Wallet é um gerenciador de finanças pessoais simples e eficiente. Controle seus gastos, acompanhe receitas e tenha visão clara do seu saldo financeiro.">
    <meta name="keywords" content="controle financeiro, gerenciador de finanças, gestão de dinheiro, planejamento financeiro, orçamento pessoal, carteira digital">
    ...
    <meta property="og:description" content="Gerencie suas finanças de forma clara e eficiente. Controle total sobre seus gastos e receitas.">
    ...
    <meta name="twitter:description" content="Gerencie suas finanças de forma clara e eficiente. Controle total sobre seus gastos e receitas.">
...
<body class="bg-zinc-950 text-zinc-100 font-sans antialiased">
    ...
    <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-lime-400 text-zinc-950 px-4 py-2 font-bold z-50">
